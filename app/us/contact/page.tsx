...
/*
 * US edition contact page — the `/contact` mirror for the International
 * edition. Same client-side form behaviour as the India page (submit flips to
 * a confirmation card); only the contact details and copy differ.
 */
...
const INFO = [
  ["mail", '<path d="M3.5 6.5h17v11a1.5 1.5 0 0 1-1.5 1.5H5a1.5 1.5 0 0 1-1.5-1.5z"/><path d="M4 7l8 6.4L20 7"/>', "Email", "hello@ambelpos.com"],
  ["phone", '<path d="M6.6 10.8a15 15 0 0 0 6.6 6.6l2.2-2.2a1.5 1.5 0 0 1 1.5-.36 10.4 10.4 0 0 0 3.3.53 1.5 1.5 0 0 1 1.5 1.5V20.5A1.5 1.5 0 0 1 20.2 22 17.5 17.5 0 0 1 2.5 4.3 1.5 1.5 0 0 1 4 2.8h3.3a1.5 1.5 0 0 1 1.5 1.5 10.4 10.4 0 0 0 .53 3.3 1.5 1.5 0 0 1-.36 1.5z"/>', "Phone", "Available by request"],
  ["pin", '<path d="M12 21.5s7-6.4 7-12a7 7 0 0 0-14 0c0 5.6 7 12 7 12z"/><circle cx="12" cy="9.5" r="2.4"/>', "Support", "Remote support for retail teams worldwide"],
];
