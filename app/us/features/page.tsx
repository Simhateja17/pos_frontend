/*
 * US edition features page — the `/features` mirror for the International
 * edition. Same design system and same `.feat-card` grid as the India page;
 * it just reads `US_FEATURES` instead of `FEATURES` and renders the chrome
 * with region="INTL" so every link stays inside the /us edition.
 */
...
export default function USFeaturesPage() {
  return (
    <>
      ...
      <section className="cta-section">
        ...
        <p>Import your products in minutes and choose the plan that fits your locations, users and registers.</p>
