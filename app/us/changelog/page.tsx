      ...
      <section className="content-section">
        {ENTRIES.length > 0 ? (
          ...
          <div className="content-wrap content-prose">
            ...
            <p>If you want to know whether a specific capability is in the product today, the <a href="/us/features">features page</a> lists only what is built and working.</p>
          </div>
        )}
      </section>
