...
export default function Page() {
  return (
    <RetailVerticalPage
      ...
      subtitle="Centralized stock, staff and reporting across unlimited locations, with per-location pricing, transfers and consolidated multi-state tax reporting."
      stats={[
      ...
      features={[
        ...
        { title: "Per-location Pricing & Tax", body: "Set different price lists, promotions and nexus settings per location while keeping one shared product catalog." },
        { title: "Consolidated Tax Reporting", body: "Roll up sales tax liability across all locations into one filing-ready export, or report per state when required." },
