...
export const metadata = { title: "Beauty & Wellness POS — Couture POS" };
  ...
  return (
    <RetailVerticalPage
      ...
      features={[
        ...
        { title: "Appointment-aware Billing", body: "Pull a booked service straight onto the bill screen — no re-typing client or service details." },
