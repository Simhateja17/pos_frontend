...
export const metadata = { title: "Privacy Policy — Couture POS" };
    ...
    <>
      ...
      <section className="content-section">
        <div className="content-wrap content-prose">
          ...
          <h2>5. Your rights</h2>
          <p>You can request an export or deletion of your account data at any time by writing to <a href="mailto:privacy@withcouture.com">privacy@withcouture.com</a>. Certain records — such as GST invoices — are retained as required by Indian tax law even after account closure.</p>

          <h2>6. Changes to this policy</h2>
          <p>We&apos;ll notify account owners by email at least 14 days before any material change to this policy takes effect.</p>

          <h2>7. Contact</h2>
          <p>Questions about this policy can be sent to <a href="mailto:privacy@withcouture.com">privacy@withcouture.com</a> or via our <a href="/contact">contact page</a>.</p>
        </div>
      </section>
      <SiteFooter />
    </>
